...
import { Helmet } from 'react-helmet'; // Import Helmet for adding scripts to head
    ...
    <>
      ...
      <Helmet>
        <script>
          ...
          })(window,document,'script','dataLayer','GTM-N5N7MBCQ');`}
        </script>
      </Helmet>

      {/* Google Tag Manager (noscript) after body opening */}
      <noscript>
        <iframe 
          src="https://www.googletagmanager.com/ns.html?id=GTM-N5N7MBCQ"
          height="0" 
          width="0" 
